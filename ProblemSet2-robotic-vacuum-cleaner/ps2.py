...
# Set this varaible to True if you want to see wonderful animations when calling runSimulation
ANIMATION = True
...
# NOTE: If you are running the simulation, you will have to close it before the plot will show up.
...
#showPlot2("Time It Takes Two Robots To Clean 80% Of Variously Shaped Rooms", "Aspect Raio", "Time-steps")