...
class RobotVisualization:
    ...
    def update(self, room, robots):
		...
		# Remove a gray square for any tiles have been cleaned.
        ...
        for robot in robots:
            ...
            self.robots.append(self._draw_robot(robot.getRobotPosition(), robot.getRobotDirection()))
        
		# Update text
        self.w.delete(self.text)
        self.time += 1
        self.text = self.w.create_text(25,
		                               0,
									   anchor=NW,
